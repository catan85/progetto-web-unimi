...
passport.use(new Strategy(
  ...
  var records = [
    { id: 1, username: 'andrea', password: 'secret', displayName: 'Andrea', emails: [ { value: 'andrea@example.com' } ] }
  , { id: 2, username: 'roberta', password: 'secret', displayName: 'Roberta', emails: [ { value: 'roberta@example.com' } ] }
  ];
